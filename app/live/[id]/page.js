      ...
      <div className="fixed w-full mx-auto max-w-md bottom-0 left-0 right-0 inset-x-0">
        <div className="flex relative items-center">
          ...
          <div className="absolute h-full inset-y-0 bottom-2 flex py-1.5 pr-1.5 right-0">
            <span className="flex h-full focus:ring-2 focus:ring-offset-2 focus:ring-teal-500 items-center bg-teal-500 rounded-full px-3  hover:bg-teal-700 cursor-pointer text-sm text-white">&rarr;</span>
          </div>
        </div>
      </div>
    </div>
