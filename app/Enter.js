    ...
    <div className="mt-16 px-4">
      ...
      <div className="mt-8">
        <div className="flex flex-col items-center">
          ...
          <div className="grid   border-gray-500   w-full  grid-cols-2 gap-16 mt-8">
            <button
              className={cls(
        ...
        <form className="flex flex-col mt-8">
          ...
          <button className="mt-6 bg-teal-500 hover:bg-teal-600 text-white py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium focus:ring-2 focus:ring-offset-2 focus:ring-teal-500 focus:outline-none">
        ...
        <div className="mt-8">
          <div className="relative">
            <div className="absolute w-full border border-teal-500 " />
            <div className="relative -top-3 text-center px-2 text-sm text-gray-500">
              <span className="bg-white">Or enter with</span>
            </div>
          </div>
          <div className="grid grid-cols-2 gap-3 mt-6">
            <button className="flex justify-center items-center py-2 px-4 border border-gray-400 rounded-md shadow-sm font-medium text-gray-500 hover:text-gray-600">
              <svg
                className="w-5 h-5"
                aria-hidden="true"
                fill="currentColor"
